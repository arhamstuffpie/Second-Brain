...
func TestAnalyzePeopleContract(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(writer http.ResponseWriter, request *http.Request) {
		...
		fmt.Fprint(writer, `{"recording_id":"r1","processing_version":3,"duration_seconds":1,"analyzed_fps":8,"tracks":[{"id":"t1","provider_track_reference":"t1","lifecycle_status":"ended","first_frame":0,"last_frame":2,"start_time":0,"end_time":0.25,"observation_count":1,"tracking_confidence":0.9,"quality":{"mean":0.8,"maximum":0.8,"usable_observations":1},"gallery_observation_ids":["o1"],"observations":[{"observation_id":"o1","frame_index":0,"timestamp":0,"box":{"x":1,"y":2,"width":80,"height":80},"landmarks":[],"detection_score":0.9,"quality":{"usable":true,"reasons":[],"score":0.8},"pose":{"yaw":0,"pitch":0,"roll":0,"bucket":"frontal"},"mouth_visible":true,"mouth_activity":0.1}]}],"provenance":{"detector_model":"yunet","embedding_model":"sface","runtime_version":"python/3.11","device":"cpu","configuration_profile":{}},"warnings":[]}`)
	}))
	defer server.Close()
